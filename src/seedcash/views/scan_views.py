...
from seedcash.views.view import BackStackView, ErrorView, MainMenuView, NotYetImplementedView, View, Destination
            ...
            if self.decoder.is_seed:
                ...
                if not seed_mnemonic:
                    ...
                    if self.settings.get_value(SettingsConstants.SETTING__PASSPHRASE) == SettingsConstants.OPTION__REQUIRED:
                        from seedcash.views.seed_views import SeedAddPassphraseView
                ...
                from seedcash.views.settings_views import SettingsIngestSettingsQRView
                ...
                from seedcash.views.seed_views import MultisigWalletDescriptorView
                ...
                from seedcash.views.seed_views import AddressVerificationStartView
                ...
                from seedcash.views.seed_views import SeedSignMessageStartView
...
class ScanInvalidQRTypeView(View):
    def run(self):
        from seedcash.gui.screens import WarningScreen
