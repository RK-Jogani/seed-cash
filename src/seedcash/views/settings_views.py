...
from seedcash.gui.components import GUIConstants, SeedSignerIconConstants
from seedcash.gui.screens import (RET_CODE__BACK_BUTTON, ButtonListScreen, settings_screens)
from seedcash.gui.screens.screen import ButtonOption
from seedcash.models.settings import Settings, SettingsConstants, SettingsDefinition
...
class SettingsIngestSettingsQRView(View):
    ...
    def run(self):
        from seedcash.gui.screens.settings_screens import SettingsQRConfirmationScreen
        self.run_screen(
